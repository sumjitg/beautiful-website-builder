    ...
    <SiteLayout>
      <section className="relative py-16 sm:py-24 overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="mt-5 text-3xl sm:text-4xl lg:text-5xl font-semibold text-foreground leading-tight">
      ...
      <section className="py-10 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            <SectionHeading
              align="left"
              eyebrow="Our Mission"
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl sm:rounded-[2rem] bg-card border border-border p-6 sm:p-8 shadow-[var(--shadow-soft)]">
              <div className="space-y-5">
                <div>
                  <div className="text-xs uppercase tracking-widest text-muted-foreground">Registration</div>
                  <div className="font-display text-xl sm:text-2xl mt-1">2019/4/22191</div>
                </div>
                <div className="h-px bg-border" />
                <div>
                  <div className="text-xs uppercase tracking-widest text-muted-foreground">Established</div>
                  <div className="font-display text-xl sm:text-2xl mt-1">20+ Years of Practice</div>
                </div>
                <div className="h-px bg-border" />
                <div>
                  <div className="text-xs uppercase tracking-widest text-muted-foreground">Location</div>
                  <div className="text-sm sm:text-base mt-1 leading-relaxed">Chisthiya Heights, Dongri, Mumbai 400009</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-4 sm:gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((v) => (
              <div key={v.title} className="rounded-2xl sm:rounded-3xl border border-border bg-card p-5 sm:p-6 hover:shadow-[var(--shadow-elegant)] transition">
